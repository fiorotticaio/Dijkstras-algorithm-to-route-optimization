...
Grafo* inicializaGrafo(Vertice** v, Aresta** a, int numVertices, int numArestas, int idVerticeOrigem, int idVerticeDestino, double dist[numVertices][numVertices], double vel[numVertices][numVertices]);
